namespace ConcurrentFlows.FindingCompletion.ConditionalBranches.Broadcast {
    using System;
    ...
    public class ConditionalBranchingFlow : Dataflow<Message, Message> {
        ...
        private static DataflowEndPoints<Message, Message> CreatePipeline() {
            ...
            var broadcastData = new BroadcastBlock<Message>(msg => {
                return new Message() {
                    Id = msg.Id,
                    Data = msg.Data,
                    ExceededBounds = msg.ExceededBounds
                };
            }, executionOptions);
            ...
            buffer.LinkTo(broadcastData, linkOptions);
            broadcastData.LinkTo(processNegativeData, linkOptions);
            broadcastData.LinkTo(processPositiveData, linkOptions);
